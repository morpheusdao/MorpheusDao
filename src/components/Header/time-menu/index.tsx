...
function TimeMenu() {
    ...
    const CYPHER_ADDRESS = addresses.CYPHER_ADDRESS;
                ...
                {({ TransitionProps }) => (
                    <Fade {...TransitionProps} timeout={200}>
                        <div className="tooltip">
                            <Link className="tooltip-item" href={`https://www.traderjoexyz.com/#/trade?inputCurrency=&outputCurrency=${CYPHER_ADDRESS}`} target="_blank">
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("CYPHER", CYPHER_ADDRESS)}>
                                        <p>CYPER</p>
                                    </div>
                                    <div className="tooltip-item" onClick={addTokenToWallet("ORACLE", ORACLE_ADDRESS)}>
                                        <p>ORACLE</p>
                                    </div>
                                </div>
                            )}

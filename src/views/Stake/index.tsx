...
function Stake() {
    ...
    const timeBalance = useSelector<IReduxState, string>(state => {
        return state.account.balances && state.account.balances.cypher;
    });
    const memoBalance = useSelector<IReduxState, string>(state => {
        return state.account.balances && state.account.balances.oracle;
    });
    const stakeAllowance = useSelector<IReduxState, number>(state => {
        return state.account.staking && state.account.staking.oracle;
    });
                    ...
                    <Grid className="stake-card-grid" container direction="column" spacing={2}>
                        <Grid item>
                            <div className="stake-card-header">
                                <p className="stake-card-header-title">CYPHER Staking (🎩, 🎩)</p>
                                <RebaseTimer />
                            </div>
                        </Grid>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <div className="stake-card-index">
                                            ...
                                            <p className="stake-card-metrics-value">{currentIndex ? <>{trim(Number(currentIndex), 2)} CYPHER</> : <Skeleton width="150px" />}</p>
                                        </div>
                                    </Grid>
                                </Grid>
                            </div>
                        ...
                        <div className="stake-card-area">
                            {!address && (
                                <div className="stake-card-wallet-notification">
                                    ...
                                    <p className="stake-card-wallet-desc-text">Connect your wallet to stake CYPHER tokens!</p>
                                </div>
                            )}
                            {address && (
                                <div>
                                    <div className="stake-card-action-area">
                                            ...
                                            {view === 0 && (
                                                <div className="stake-card-tab-panel">
                                                    {address && hasAllowance("time") ? (
                                                        ...
                                                        >
                                                            <p>{txnButtonText(pendingTransactions, "staking", "Stake CYPHER")}</p>
                                                        </div>
                                                    ) : (
                                                        <div
                                                            className="stake-card-tab-panel-btn"
                                            ...
                                            {view === 1 && (
                                                <div className="stake-card-tab-panel">
                                                    {address && hasAllowance("oracle") ? (
                                                        ...
                                                        >
                                                            <p>{txnButtonText(pendingTransactions, "unstaking", "Unstake Cypher")}</p>
                                                        </div>
                                                    ) : (
                                                        <div
                                                            className="stake-card-tab-panel-btn"
                                        ...
                                        <div className="stake-card-action-help-text">
                                            {address && ((!hasAllowance("cypher") && view === 0) || (!hasAllowance("oracle") && view === 1)) && (
                                                <p>
                                    ...
                                    <div className="stake-user-data">
                                        <div className="data-row">
                                            ...
                                            <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{trim(Number(timeBalance), 4)} CYPHER</>}</p>
                                        </div>

                                        <div className="data-row">
                                            <p className="data-row-name">Your Staked Balance</p>
                                            <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{trimmedMemoBalance} ORACLE</>}</p>
                                        </div>

                                        <div className="data-row">
                                            <p className="data-row-name">Next Reward Amount</p>
                                            <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} ORACLE</>}</p>
                                        </div>
